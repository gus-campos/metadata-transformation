...
import { checkMatch } from "../src/processing/check-match-condition";
...
describe("checkMatch — campo simples", () => {
    it("retorna true quando o campo bate", () => {
        expect(
            checkMatch(instance, { nome: { _anyOf: ["João"] } }),
        ).toBe(true);
    });

    it("retorna false quando o campo não bate", () => {
        expect(
            checkMatch(instance, { nome: { _anyOf: ["Maria"] } }),
        ).toBe(false);
    });

    it("compara com null", () => {
        expect(
            checkMatch(instance, { ativo: { _anyOf: [null] } }),
        ).toBe(true);
    });

    it("compara com número", () => {
        expect(checkMatch(instance, { idade: { _anyOf: [30] } })).toBe(
            true,
        );
        expect(checkMatch(instance, { idade: { _anyOf: [99] } })).toBe(
            false,
        );
    });
...
describe("checkMatch — múltiplos campos", () => {
...
describe("checkMatch — combinações", () => {
    it("campo + _not", () => {
        expect(
            checkMatch(instance, {
                nome: { _anyOf: ["João"] },
            ...
            checkMatch(instance, {
                _not: {
                    _some: {
                        nome: { _anyOf: ["Maria"] },
                        idade: { _anyOf: [99] },
                    }, // nenhum bate → _some false → _not true
                },
            }),
        ).toBe(true);
    });
...
describe("checkMatch — path aninhado", () => {
    it("acessa campo aninhado via path", () => {
        expect(
            checkMatch(instance, {
                "endereco.cidade": { _anyOf: ["BH"] },
            }),
        ).toBe(true);
    });
...
describe("checkMatch — campo é array, busca valor único", () => {
    it("retorna true quando o valor está no array", () => {
        expect(
            checkMatch(instanceWithArrays, {
                tags: { _anyOf: ["admin"] },
            }),
        ).toBe(true);
    });
...
describe("checkMatch — campo é valor único, busca com array", () => {
    ...
    it("retorna true para array esperado vazio", () => {
        expect(
            checkMatch(instanceWithArrays, { status: { _anyOf: [] } }),
        ).toBe(true);
    });
...
describe("checkMatch — campo é array, busca em array", () => {
    ...
    it("retorna true quando array esperado é vazio", () => {
        expect(
            checkMatch(instanceWithArrays, { tags: { _anyOf: [] } }),
        ).toBe(true);
    });
...
describe("checkMatch — arrays com _not e _some", () => {
...
describe("checkMatch — campo é array, busca com _allOf", () => {
    it("retorna true para _allOf vazio (nenhum requisito)", () => {
        expect(
            checkMatch(instanceWithArrays, { tags: { _allOf: [] } }),
        ).toBe(true);
    });
    ...
    it("retorna true para _allOf vazio mesmo com campo vazio", () => {
        expect(
            checkMatch(instanceWithArrays, { vazio: { _allOf: [] } }),
        ).toBe(true);
    });
...
describe("checkMatch — campo é objeto, _anyOf verifica subset profundo", () => {
    it("retorna true quando o subset passado é vazio", () => {
        expect(
            checkMatch(instanceWithObject, {
                endereco: {
                    _anyOf: [{}],
                },
            }),
